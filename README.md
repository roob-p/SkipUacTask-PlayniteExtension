...
- You can edit these variables:
  ...
  - `$global:newaction_actionstart:` This variable defines the behaviour of the mew SkipUacTask action created. If $True the new action is set like IsPlay, which mean that the new can starts the game.
